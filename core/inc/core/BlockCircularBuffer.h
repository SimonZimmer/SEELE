...
#include "../../../seele/seeleCore/tests/inc/matplotlibcpp.h"
...
namespace sz
{
    ...
    class BlockCircularBuffer final
    {
    public:
        ...
        void read(core::AudioBuffer<float>& destBuffer, int offset, const long destLength)
        {
            ...
            std::vector<float> readVec {destBufferData, destBufferData + destBuffer.getNumSamples() * destBuffer.getNumChannels()};
            matplotlibcpp::plot(readVec);
        }
        ...
        void write(core::AudioBuffer<float>& sourceBuffer, const int offset, const long writeLength)
        {
            ...
            std::vector<float> writeVec {sourceBufferData, sourceBufferData + sourceBuffer.getNumSamples() * sourceBuffer.getNumChannels()};
            matplotlibcpp::plot(writeVec);
        }
